...
export const DashboardFooter = () => {
    ...
    <footer className="v-footer-main rounded-lg" id="v-footer">
      {/*  */}
			<div className="v-footer-inner xs:w-11/12 xl:w-5/6 mx-auto"> 
				<section className="v-main-footer w-full mx-auto relative px-0 md:px-0 pb-4 sm:pb-5 v-footer-navigations">
				...
				<div className="py-6 px-0 md:px-0 relative">
