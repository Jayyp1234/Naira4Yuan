...
import { DashboardSkeleton, RecipientsSkeleton } from "@/components/Skeleton/Skeleton";
      ...
      <section className="my-8 flex flex-col gap-y-5">
        <div className="flex items-center gap-x-2">
          <button
            ...
            className={`animate-active rounded-no-tl font-medium flex items-center justify-center py-1.5 px-3.5 rounded-lg ${activeTab === "all" ? "text-black bg-[#F1C34E]" : "bg-transparent"
              }`}>
            All
          </button>
          <button
            onClick={() => setActiveTab("my-accounts")}
            className={`animate-active  rounded-no-tl font-medium flex items-center justify-center py-1.5 px-3.5 rounded-lg ${activeTab === "my-accounts" ? "text-black bg-[#F1C34E]" : "bg-transparent"
              }`}>
            My accounts
          </button>
        </div>
