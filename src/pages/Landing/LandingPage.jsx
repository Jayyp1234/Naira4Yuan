...
import {
  PostHero,
  ThreeAsides,
} from "../../components/PageComponents/Landing/PostHero";
      ...
      <section className="relative v-each-section has-bg" id="v-hero">
        ...
        <div className="relative w-full pb-8 mx-auto v-hero-inner lg:w-11/12 xl:w-9/12 lg:pb-48">
          <div className="relative px-3 py-24 mt-4 lg:px-0">
            <FloatingItem
              src={CoilWave}
              cn="top-1/3 left-4 w-24 rotate-[240deg] hidden md:flex blur-sm md:blur-none"
            />
            <div className="items-center mx-auto lg:items-start gap-y-8">
              <aside className="p-0 v-aside">
                <div className="relative flex flex-col justify-center mx-auto text-center v-hero-content gap-y-3 col-12 xs:w-11/12 xl:w-9/12 lg:pt-4">
                  <FloatingItem
                    src={bluePlus}
                    cn="-top-5 left-1/3 -translate-x-4 w-24 blur-sm md:blur-none"
                  />
                  <FloatingItem
                    src={yellowStar}
                    cn="top-1/3 right-0 lg:-right-1/4 -translate-x-4 w-24 blur-sm md:blur-none"
                  />
                  <div className="relative flex items-center justify-center text-white gap-x-3">
                    ...
                    <div className="flex items-center gap-x-1">
                      ...
                      <span className="flex text-sm leading-tight">
                        Truspilot
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="relative flex flex-col items-center w-full mx-auto text-center v-hero-text-content sm:w-9/12 md:w-8/12 lg:w-7/12">
                    <span className="text-white v-text">
                      The fastest 🚀 way to make payment for goods and services
                      in China
                    ...
                    <div className="relative w-full mt-5 mb-6">
                      <FloatingItem
                        src={orangeStar}
                        cn="-top-5 -right-2 z-[1]"
                      />
                      <FloatingItem
                        src={greenPlus}
                        cn="-bottom-8 -left-4 z-[1]"
                      />
                      <input
						type="email"
						value={email}
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-3 mt-1">
                      <Link
                        to={routes.LINKS.googlestore}
                        className="v-store-link"
                      >
                        <figure
                          className="v-store-link-image !w-28 sm:!w-32"
                          title="Playstore"
                        >
                          <img
                            src={playstore}
